  ...
  <body>
    <nav>
      <div class="nav">
        ...
        <div class="nav-right">
          <p><span>C</span>reate <span>W</span>eekly <span>S</span>chedule</p>
        </div>
      </div>
    </nav>
    <div class="main">
      <div class="sample" id="sample">
        ...
        <div class="warning">
          <p>
            ...
            next week unless you want to follow the
            same schedule.
          </p>
        </div>
      </div>
      ...
      <div class="textArea" id="textArea">
        <h3>your schedule</h3>
        <form action="../modules/getWeeklySchedule.php" method="POST">
        <textarea id="weeklySchedule" name="weeklySchedule"></textarea>
        <script>
          tinymce.init({
            selector: "textarea",
            plugins:
      ...
      <div class="button">
       <input type="submit" value="SAVE SCHEDULE" id="save"/>
      </div>
    </form>
    </div>
  </body>
